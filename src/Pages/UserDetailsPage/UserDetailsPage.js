    ...
    <div className=" min-h-screen py-20 bg-[#F1F3FA]">
      ...
      <div className=" w-3/4 mx-auto ">
        ...
        <Link to="/users" target="_blank">
            <button className="mt-10 px-10  bg-[#bb202e] text-white py-2 border-2 border-[#bb202e] hover:bg-white hover:text-[#bb202e] duration-500 rounded-md">
        ...
        <div className="bg-[#ffffff] text-center py-10 rounded-lg">
          ...
          <p className=" mt-2 text-[#692438] text-xl font-bold">{username}</p>
          <p className=" mt-4 text-gray-500 text-base font-bold">
        ...
        <div className="bg-[#ffffff] col-span-2 rounded-lg">
