...
const About = () => {
  ...
  return (
  <div className=" w-[90%] sm:w-3/4 lg:w-3/5 mb-10 mx-auto -mt-6 md:-mt-10 lg:-mt-14">
    <div className=" border-2 border-[#6A2639] mb-5">
      <div className="bg-[#6A2639] text-white grid grid-cols-8 items-center">
        <img src={shapeImg} alt="" className=" col-span-2 md:col-span-1 w-10 h-10 mx-auto" />
      ...
      <div className=" text-[#6A2639] grid grid-cols-8 items-center">
        <h2 className="lg:border-r-2 border-[#6A2639]  py-5 col-span-2 md:col-span-1 text-base lg:text-xl font-bold text-center">$46,000</h2>
        <p className=" border-l-2 lg:border-l-0 border-[#6A2639] p-3 col-span-6 md:col-span-7 text-base lg:text-xl">If you earn less than $46,000 adter graduation, we can help repay ypur student loadns.</p>
      </div>
    </div>
    <div>
    {
